  ...
  <div>
    ...
    >  
     <el-row>
         ...
         <el-col :span="12">
           <el-form-item v-if="flag=='xuesheng'"  label='年级' prop="xueshengNianji">
               <el-input v-model="ruleForm.xueshengNianji"  placeholder='年级' clearable></el-input>
           </el-form-item>
         </el-col>
...
export default {
  ...
  methods: {
    ...
    onUpdateHandler() {
                         ...
                         if((!this.ruleForm.xueshengNianji)&& 'xuesheng'==this.flag){
