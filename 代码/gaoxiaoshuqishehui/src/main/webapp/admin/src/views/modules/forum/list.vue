...
<template>
    <div class="main-content">
        <el-dialog title="帖子回复详情" :visible.sync="forumReplyDialogVisible">
            ...
            <el-table :data="forumData" height="250" style="margin-top: 5px;">
                <!--<el-table-column label="id" width="40"></el-table-column>-->
                <el-table-column label="身份" fixed>
                ...
                <el-row class="ad" :style="{justifyContent:contents.btnAdAllBoxPosition=='1'?'flex-start':contents.btnAdAllBoxPosition=='2'?'center':'flex-end'}">
                    <el-form-item>
                        ...
                        <a style="text-decoration:none" class="el-button el-button--success"
                           ...
                           href="http://localhost:8080/gaoxiaoshuqishehui/upload/forumMuBan.xls"
                        >批量导入心得交流数据模板</a>
                        &nbsp;
                        <el-upload
                                v-if="isAuth('forum','导入导出')"
                ...
                _this.$http({
                    ...
                    if (data && data.code === 0) {
                        ...
                        data.data.list.forEach(el=>{
                            ...
                            forum.xueshengNianji = el.xueshengNianji;
