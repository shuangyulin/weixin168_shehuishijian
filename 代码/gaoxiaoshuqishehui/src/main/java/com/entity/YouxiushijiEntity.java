...
public class YouxiushijiEntity<T> implements Serializable {
    private static final long serialVersionUID = 1L;


	public YouxiushijiEntity() {

	}

	public YouxiushijiEntity(T t) {
		try {
     ...
     * 标题
     */
    @TableField(value = "youxiushiji_name")
     ...
     * 相关人物
     */
    @TableField(value = "youxiushiji_renwu")
     ...
     * 事迹类型
     */
    @TableField(value = "youxiushiji_types")
     ...
     * 图片
     */
    @TableField(value = "youxiushiji_photo")
     ...
     * 详情
     */
    @TableField(value = "youxiushiji_content")
    ...
    public String toString() {
        return "Youxiushiji{" +
            "id=" + id +
            ", youxiushijiName=" + youxiushijiName +
            ", youxiushijiRenwu=" + youxiushijiRenwu +
            ", youxiushijiTypes=" + youxiushijiTypes +
            ", youxiushijiPhoto=" + youxiushijiPhoto +
            ", youxiushijiContent=" + youxiushijiContent +
